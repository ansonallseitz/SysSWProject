...
void firstRiddle(player player1){
  cout<< "In the box there is an inscripted tablet with 4 blocks.\n";
  cout<< "Each of the blocks has a word on it, and there is a space under\n";
  cout<< "The enscription that looks like a block fits in.\n";
  ...
  cin >> riddleChoice; 
   while (riddleChoice <= 0 || riddleChoice > 4){
    cout<<"Please choose '1' for Roots, '2' for Death, '3' for Darkness, or '4' for The Night.\n";
    cin>>riddleChoice;
  }
  if (riddleChoice ==3){
...
//create the player
  ...
  /*
I have added a simple menu to control the processes of the game and keep looping until the player exits the game
- aireche
*/
...
void startGame(player player1){
  ...
  cout<<"You've been kidnapped by an evil wizard! \n He's locked you in his dungeon and tells you there is no escape.\n Unfortunately for him, you've got a plan.\n You decide to sneak through the hole in the floor and out into a hidden hallway with doors on each side. \n What will happen next?...\n";
...
void roomOne(player player1){
  ...
  cout<<"------------------------------\n";
  cout<<"\n\nYou try the red door. The room is dark but you stumble towards the wall and find a heavy switch. \n"<<"The lights flicker on and you see a large rat! Not just large, GIANT!";
  ...
  cin>>gamePlayChoice;
    while(gamePlayChoice <= 0 || gamePlayChoice > 3){
      cout<< "Please enter '1' for attack, '2' for defend, or '3' for use item.\n";
      cin>>gamePlayChoice;
    }
...
void roomTwo(player player1){
  ...
  // the box plays a riddle, but you die if you don't open it. 
    //inside of this chest will be a riddle, if they solve it they pass, if they dont choose the right answer they automatically lose and end game
  ...
  if(roomTwoChoiceOne == 1){
    ...
    cout<< "You start to hear a hissing noise, and a cloudy white mist fills the room\n";
    cout<< "You get the urge to cough, and suddenly your hands are covered in blood.\n";
    cout<< "The dizzyness overwhelmes you, everything goes black.\n";
    loseGame(player1); 
    return; 
  } 
...
//set player HP back to 100
  ...
  cout<<"------------------------------\n";
  cout<<"You step through the black door into another dark room. \nBut alas! You see a light peeking through a crack in the back wall. \nYou kick at the crumbling bricks and the wall gives way, but out jumps the ugliest Goblin you've ever seen! \nHe's snarling and ready to attack.";
...
void roomThreePartTwo(player player1){
  ...
  cout<<player1.getName()<<"s health regenerates!\n";
  cout<<"Player HP: "<<player1.getHP()<<"\n\n";
  //We can make the player head back to room three from room 4, and this will be the second part of the fight in room 3.
  
  character enemy5("Big Goblin", 100, 28, 0);
  
  cout<<"You reach a fork in the hallway and get turned around, you're back in room 3! The Goblin you just killed, well, his friend has found him and he's a lot bigger than he was.";
...
//this room has a physical attack
  ...
  cout<<"You step through the door with water drops painted on it and immediately fall through the floor and into an underground tunnel. The water is up to your waist but you must push forward. Finally you find a ladder that leads to another door. Inside that room is a robot...WITH GLOWING RED EYES! That can't be good.";
...
void roomFive(player player1){
  ...
  cout<<"Once you make your way through the door with leaves poking through the cracks, you realize you are outside! Are you free? Was it all a dream? Of course it wasn't that easy. You see a sign and read (...)";
...
void roomSix(player player1){
  ...
  //dialogue or riddle function under this line
...
void loseGame(player player1){
  ...
  cout<<"You have fought rigorously through the challenges "<< player1.getName()<<"\n, but you have lost! Better luck next time.\n\n";
}
